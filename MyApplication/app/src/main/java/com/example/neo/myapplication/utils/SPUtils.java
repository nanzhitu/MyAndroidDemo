...
public class SPUtils {
	...
	public static boolean getBooleanFromPreferencesManager(Context context,String key,boolean defValue){
		return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(key, defValue);
	}
	public static int getIntFromPreferencesManager(Context context, String key,int defValue){
	...
	public static long getLongFromPreferencesManager(Context context, String key,long defValue){
        String value =  PreferenceManager.getDefaultSharedPreferences(context).getString(key, "");
        if (TextUtils.isEmpty(value)){
            return defValue;
        }else{
	...
	public static float getFloatFromPreferencesManager(Context context, String key,float defValue){
		String value = PreferenceManager.getDefaultSharedPreferences(context).getString(key, "");
		if (TextUtils.isEmpty(value)){
			return defValue;
		}else{
